...
let setButtons = function (camera) {
    ...
    let switchBox = function () {
        ...
        //enable control for this editcontrol
        switchSpace();
    ...
    let helpButton =  <HTMLInputElement>document.getElementById("showHelp");
    let closeButton =  <HTMLInputElement>document.getElementById("closeHelp");
    let help = function(){
